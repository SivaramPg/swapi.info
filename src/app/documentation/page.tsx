...
import { FaqJsonLd, TechArticleJsonLd } from "@/components/json-ld"
...
const ApiGuidePage = (): JSX.Element => {
	...
	"url": "https://swapi.info/api/planets/1"
				...
				<p className="mb-4">
					The documentation below assumes you are prepending this Base URL to
					the endpoints to make requests.
				</p>
				...
				<p className="mb-4">
					Swapi is a completely open API. Key points regarding authentication
					and access include:
				</p>
				<ul>
	...
	"url": "https://swapi.info/api/people/1"
				...
				<ul>
					...
					<li>
						...
						the in-universe standard of BBY or ABY - Before the Battle of Yavin
						or After the Battle of Yavin. The Battle of Yavin is a battle that
						occurs at the end of Star Wars episode IV: A New Hope.
					</li>
					<li>
						<code>eye_color</code> string-- The eye color of this person. Will
						be "unknown" if not known or "n/a" if the person does not have an
						eye.
					</li>
					<li>
						<code>gender</code> string-- The gender of this person. Either
						"Male", "Female" or "unknown", "n/a" if the person does not have a
						gender.
					</li>
					<li>
					...
					<li>
						<code>height</code> string-- The height of the person in
						centimeters.
					</li>
					<li>
					...
					<li>
						<code>homeworld</code> string-- The URL of a planet resource, a
					...
					<li>
						<code>starships</code> array-- An array of starship resource URLs
						that this person has piloted.
					</li>
					<li>
					...
					<li>
						<code>edited</code> string-- the ISO 8601 date format of the time
						that this resource was edited.
					</li>
				</ul>
	...
	"url": "https://swapi.info/api/films/1"
				...
				<ul>
					...
					<li>
						<code>director</code> string-- The name of the director of this
						film.
					</li>
					<li>
						<code>producer</code> string-- The name(s) of the producer(s) of
						this film. Comma separated.
					</li>
					<li>
					...
					<li>
						<code>characters</code> array-- An array of people resource URLs
						that are in this film.
					</li>
					<li>
						<code>planets</code> array-- An array of planet resource URLs that
						are in this film.
					</li>
					<li>
						<code>url</code> string-- the hypermedia URL of this resource.
	...
	"url": "https://swapi.info/api/starships/9"
				...
				<ul>
					<li>
						<code>name</code> string-- The name of this starship. The common
						name, such as "Death Star".
					</li>
					<li>
					...
					<li>
						<code>starship_class</code> string-- The class of this starship,
						such as "Starfighter" or "Deep Space Mobile Battlestation"
					</li>
					<li>
						<code>manufacturer</code> string-- The manufacturer of this
						starship. Comma separated if more than one.
					</li>
					<li>
					...
					<li>
						<code>max_atmosphering_speed</code> string-- The maximum speed of
						this starship in the atmosphere. "N/A" if this starship is incapable
					...
					<li>
						<code>consumables</code> <em>string</em> -- The maximum length of
						time that this starship can provide consumables for its entire crew
					...
					<li>
						<code>pilots</code> array-- An array of People URL Resources that
						this starship has been piloted by.
					</li>
					<li>
						<code>url</code> string-- the hypermedia URL of this resource.
					</li>
  ...
  "properties": {
    ...
    "vehicle_class": "wheeled"
				...
				<ul>
					<li>
						<code>name</code> string-- The name of this vehicle. The common
						name, such as "Sand Crawler" or "Speeder bike".
					</li>
					<li>
						<code>model</code> string-- The model or official name of this
					...
					<li>
						<code>vehicle_class</code> string-- The class of this vehicle, such
						as "Wheeled" or "Repulsorcraft".
					</li>
					<li>
					...
					<li>
						<code>cost_in_credits</code> string-- The cost of this vehicle new,
						in Galactic Credits.
					</li>
					<li>
						<code>crew</code> string-- The number of personnel needed to run or
					...
					<li>
						<code>max_atmosphering_speed</code> string-- The maximum speed of
						this vehicle in the atmosphere.
					</li>
					<li>
						<code>cargo_capacity</code> string-- The maximum number of kilograms
					...
					<li>
						<code>consumables</code> <em>string</em> -- The maximum length of
						time that this vehicle can provide consumables for its entire crew
						without having to resupply.
					</li>
					<li>
						<code>films</code> array-- An array of Film URL Resources that this
					...
					<li>
						<code>pilots</code> array-- An array of People URL Resources that
						this vehicle has been piloted by.
					</li>
					<li>
						<code>url</code> string-- the hypermedia URL of this resource.
					</li>
	...
	"url": "https://swapi.info/api/species/3"
				...
				<ul>
					...
					<li>
						...
						eye colors for this species, "none" if this species does not
						typically have eyes.
					</li>
					<li>
					...
					<li>
						<code>homeworld</code> string-- The URL of a planet resource, a
						planet that this species originates from.
					</li>
					<li>
						<code>people</code> array-- An array of People URL Resources that
						are a part of this species.
					</li>
					<li>
						<code>films</code> array-- An array of Film URL Resources that this
	...
	"url": "https://swapi.info/api/planets/1"
				...
				<ul>
					...
					<li>
						<code>rotation_period</code> string-- The number of standard hours
						it takes for this planet to complete a single rotation on its axis.
					</li>
					<li>
